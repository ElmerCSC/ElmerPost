# ElmerPost
Repository for the old preprocessor of Elmer FEM suite, ElmerPost
...
Because the code is more or less obsolite it was moved to a separate repository. If you have an old compilation system the subdirectory "post" here is one-to-one copy from the main repository. Hence you can make a symlink to that and everything in your compilation script should work as before.
